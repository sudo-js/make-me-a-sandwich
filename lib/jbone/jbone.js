...
// provide width and height, modern only
jBone.fn.height = function(value) {
  ...
  if(value === undefined) { 
    ...
    if(el.style) el.style.height = typeof value === 'string' ? value : value + 'px';
  }
  return this;
};

jBone.fn.width = function(value) {
  var offset, el = this[0];
  if(value === undefined) { 
    ...
    if(el.style) el.style.Width = typeof value === 'string' ? value : value + 'px';
  }
  return this;
};
// we need that noop
jBone.noop = function(){};
// a simplified param metod
jBone.param = function(obj) {
